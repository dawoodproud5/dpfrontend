      ...
      <div className="grid  grid-cols-1 md:grid-cols-12  mt-6 bg-white">
        ...
        <div className="w-full mx-auto bg-white min-h-screen  md:col-start-4 md:col-span-6 p-2 my-12">
          <p className="px-2 text-[18px] leading-8 font-normal mb-[1rem] font-Inter">
            ...
            channels grow. As a wise person once said, &quot;Don&#39;t tell me,
            show me.&quot; And that&#39;s exactly what we&#39;re doing here.
            <br />
            <br />
            ...
            you&#39;re a beauty guru, a gaming enthusiast, or a business owner,
          ...
          <div className="">
            <p className="px-2 text-[18px] leading-8 font-normal mb-[1rem] font-Inter">
              If you&#39;re interested in exploring our complete list of YouTube
              channels across various niches for promotional purposes, please
              don&#39;t hesitate to contact us at our official number. We&#39;ll
              work with you to identify the most relevant channel for your needs
              and help you achieve your YouTube Growth goals.
            </p>
          </div>
        </div>
      </div>
