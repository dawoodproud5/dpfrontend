                ...
                <div className='flex flex-col justify-center items-center text-[black] font-Inter space-y-8 w-full max-w-[1172px] mx-auto p-4 '>
                    ...
                    <div className='flex flex-col gap-1 ml-[8%] md:ml-[6%] lg:ml-[6%] space-y-4 '>
                        <div>
                            ...
                            <ul className='font-normal text-[12px] sm:text-[14px] md:text-[18px] list-disc leading-6 sm:leading-9 px-4'>
                        ...
                        <div>
                            ...
                            <p className="font-normal text-[12px] sm:text-[14px] md:text-[18px]  leading-6 sm:leading-9 p-1">At our organization, we believe that taking care of our employees is crucial for building a strong and positive work culture. That&#39;s why we offer a range of perks and benefits that make our workplace an enjoyable and fulfilling environment for everyone. Like:</p>
                            <ul className='font-normal text-[12px] sm:text-[14px] md:text-[18px] list-disc  leading-6 sm:leading-9 p-4'>
                            ...
                            <p className="font-normal text-[12px] sm:text-[14px] md:text-[18px]  leading-6 sm:leading-9 p-1">We understand that a happy and satisfied employee is the key to Happy Clients. That&#39;s why we go the extra mile to create a supportive environment where you can thrive. Joining our team means not just a job, but an experience of a lifetime. We Really Appreciate Sir Dawood, for his Kind services and for creating an atmosphere where every team member is valued and respected. So, apply now without any worries, and let us take care of your career growth!</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p className='font-normal text-[12px] sm:text-[14px] md:text-[18px] '>At our Organization, you will be trained you as “YouTube Content Strategist”. After getting proper training, You will be responsible to:</p>
                            <ul className='font-normal text-[12px] sm:text-[14px] md:text-[18px] list-disc  leading-6 sm:leading-9 p-4'>
                            ...
                            <p className="font-normal text-[12px] sm:text-[14px] md:text-[18px] list-disc  leading-6 sm:leading-9 p-1">
                        ...
                        <div>
                            ...
                            <p className='font-normal text-[12px] sm:text-[14px] md:text-[18px] '>We take our recruitment process seriously to ensure that we hire the best fit for our team. Here&#39;s what you can expect from the selection process:</p>
                            <ul className='font-normal text-[12px] sm:text-[14px] md:text-[18px] list-disc  leading-6 sm:leading-9 p-4'>
