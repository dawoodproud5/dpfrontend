...
function Portfolio() {
  ...
  return (
    <div className="w-full min-h-screen font-Inter text-white bg-white h-full">
      <Head>
        <title>Portfolio of YouTube Growth Services Success</title>
        <meta
          name="description"
          content="Discover our YouTube service success stories in our portfolio. From Alux.com to WatchMojo and more, our expert team has a proven track record of driving significant growth in viewership and subscribers."
        />
      </Head>
